...
namespace SoftTrans.Service.Common
{
    public class AsposeExcelTools
    {
        ...
        public static bool DataTableToExcelWithCaption(System.Data.DataTable datatable, string filepath, out string error)
        {
            error = "";
            ...
            try
            {
                if (datatable == null)
                {
                    error = "DataTableToExcelWithCaption:datatable 为空";
                    return false;
                }
            ...
            {
                error = error + " DataTableToExcelWithCaption: " + e.Message;
                return false;
            }
